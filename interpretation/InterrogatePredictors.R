...
#'
#' The function inform on the proportion of the covariate importance through a stacked barchart.
#'
#' @param covariate_data An exported `data.frame` (see: `data(bam_covariate_importance)` where rows are covariates and
#'        columns denote the relative influence of for a given bootstrap replicate by species by BCR permutation.
#'
#' @param species character. Species to be summarised. Common name, scientific name or FLBCs denoting the species of interest can be used.
#'        Naming follows the taxonomy of the AOS 64th Supplement (July 21, 2023). Default is `"all"`. Run sppList from BAM exploreR to see
#'        available species.
#'
